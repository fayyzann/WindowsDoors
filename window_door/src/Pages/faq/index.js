...
function Faq() {
  ...
  return (
    ...
    >
      ...
      <div className="min-h-fit w-full px-16 flex items-start justify-end">
        <div className="w-2/3 min-h-fit p-20 bg-white flex-col items-center justify-center">
          <p className="text-4xl text-gray-800 mb-10 font-bold">
